...
Tmux config from https://github.com/hendrikmi/dotfiles (check original repo)

Few changes taken from https://github.com/radleylewis/dotfiles/tree/master/.config/tmux
